...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (strlen($title) >= 2) {
        ...
        $sql = "INSERT INTO `bom` (`book_id`, `title`, `author`, `year_published`, `review`, `created_at`, `user_id`) VALUES (NULL, '$title', '$author', '$year_published', '$review', '$created_at', '$_SESSION[user_id]')";
